...
def _generate_request_headers(credential):
    ...
    _credential = credential.client_id + ':' + credential.client_secret
    #_credential = b'{_credential}'
    #b64_encoded_credential = base64.b64encode(credential.client_id + ':' +
    # credential.client_secret)
    b64_encoded_credential = base64.b64encode(_credential.encode('utf-8'))
    #b64_utf8_encode = b64_encoded_credential.encode('utf-8')
    headers = {
